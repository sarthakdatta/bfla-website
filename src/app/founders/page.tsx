...
const founders = [
  {
    name: "Rishan Kayal",
    role: "Co-Founder",
    description: "Hello! I’m Rishan and have lots of experience tutoring middle schoolers. I love math and am currently taking a senior level math class as a sophomore.",
